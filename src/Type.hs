...
data Combined_widget a=Leaf_widget (Engine a->Event->Id) (Single_widget a)|Node_widget (Engine a->Event->Id) (Engine a->Event->Int) (Engine a->Event->Event) (Engine a->Request a->Request a) Int
...
data Combined_widget_request a=Leaf_widget_request (Engine a->Event->Id) (Single_widget_request a)|Node_widget_request (Engine a->Event->Id) (Engine a->Event->Int) (Engine a->Event->Event) (Engine a->Request a->Request a) (DIS.IntMap (Combined_widget_request a))
