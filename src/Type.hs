...
data Combined_widget a=Leaf_widget (Engine a->Event->Id) (Single_widget a)|Node_widget (Engine a->Event->Id) (Engine a->Event->Int) (Engine a->Event->Event) (Engine a->Request_widget a->Request_widget a) Int
...
data Request_widget a=Create_widget (Combined_widget_request a)|Remove_widget|Replace_widget (Combined_widget_request a)|Alter_widget (Combined_widget_request a)|Render_rectangle_widget|Render_picture_widget|Render_text_widget|Render_editor_widget|Update_block_font_widget Int FCT.CInt (DSet.Set Char)

data Combined_widget_request a=Leaf_widget_request (Engine a->Event->Id) (Single_widget_request a)|Node_widget_request (Engine a->Event->Id) (Engine a->Event->Int) (Engine a->Event->Event) (Engine a->Request_widget a->Request_widget a) (DIS.IntMap (Combined_widget_request a))
...
write_solo_data (DTu.MkSolo solo)=Node_widget_request (\_ _->End) (\_ _->0) (const id) (const id) (DIS.insert 1 (write_data solo) (DIS.singleton 0 (Leaf_widget_request (\_ _->End) (Label_data_request (Solo_label (label_data solo))))))
...
write_tuple_data (first,second)=Node_widget_request (\_ _->End) (\_ _->0) (const id) (const id) (DIS.insert 2 (write_data second) (DIS.insert 1 (write_data first) (DIS.singleton 0 (Leaf_widget_request (\_ _->End) (Label_data_request (Tuple_label (label_data first) (label_data second)))))))
...
write_list_data list=let list_length=length list in let request=write_list_data_a list list_length DIS.empty in Node_widget_request (\_ _->End) (\_ _->0) (const id) (const id) (DIS.insert 0 (Leaf_widget_request (\_ _->End) (Label_data_request (List_label (label_list_data list) list_length))) request)
