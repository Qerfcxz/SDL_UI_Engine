...
data Geometry_request=Rectangle_request Bool FCT.CInt FCT.CInt FCT.CInt FCT.CInt|Rounded_rectangle_request Bool FCT.CInt FCT.CInt FCT.CInt FCT.CInt FCT.CInt|Ellipse_request (Either Bool Bool) FCT.CInt FCT.CInt FCT.CInt FCT.CInt
