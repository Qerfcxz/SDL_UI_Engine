...
deliver_a::GS.HasCallStack=>Int->(Int->Request a->Bool)->Maybe (DIS.IntMap (Combined_widget a))->(DS.Seq (Request a),Maybe (DIS.IntMap (Combined_widget a)))
...
deliver_b::GS.HasCallStack=>(Int->Request a->Bool)->Maybe (Combined_widget a)->(DS.Seq (Request a),Maybe (Combined_widget a))
...
deliver_with_retain::GS.HasCallStack=>DS.Seq Int->(Int->Request a->Bool)->Engine a->Engine a
...
deliver_with_flush_a::GS.HasCallStack=>Int->Maybe (DIS.IntMap (Combined_widget a))->(DIS.IntMap (Request a),Maybe (DIS.IntMap (Combined_widget a)))
...
deliver_with_flush_b::GS.HasCallStack=>Maybe (Combined_widget a)->(DIS.IntMap (Request a),Maybe (Combined_widget a))
