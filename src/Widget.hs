                                                                                    ...
                                                                                    then do
                                                                                        ...
                                                                                        case something of
                                                                                            ...
                                                                                            Just (cursor_row,new_cursor,new_seq_seq_char,maybe_intmap_texture)->case maybe_intmap_texture of
                                                                                                Nothing->return (Nothing,Just (Leaf_widget next_id (Editor window_id block_number row_number (if row<=cursor_row&&cursor_row<row+row_number then row else min (DS.length new_seq_seq_char-row_number) cursor_row) design_font_size font_size True path find typesetting text_red text_green text_blue text_alpha cursor_red cursor_green cursor_blue cursor_alpha select_red select_green select_blue select_alpha height design_block_width design_delta_height design_x design_y design_extra_width design_extra_height font_height block_width delta_height x y left right up down new_cursor new_seq_seq_char)))
