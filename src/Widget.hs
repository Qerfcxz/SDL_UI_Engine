...
create_editor_trigger::Bool->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Click,Mouse)->DS.Seq (Click,Mouse)->(Event->Engine a->Id)->DS.Seq Int->DS.Seq (DS.Seq Int)->Engine a->IO (Engine a)
...
create_editor_trigger_a::Bool->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Click,Mouse)->DS.Seq (Click,Mouse)->DS.Seq (DS.Seq Int)->Event->Engine a->IO (Engine a)
...
create_editor_trigger_b::Bool->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Press,Key)->DS.Seq (Click,Mouse)->DS.Seq (Click,Mouse)->DS.Seq Int->Int->Event->DIS.IntMap (DIS.IntMap (Combined_widget a))->IO (DIS.IntMap (DIS.IntMap (Combined_widget a)))
                                ...
                                then case get_cursor_row cursor of
                                    ...
                                    then case get_cursor_row cursor of
                                        ...
                                        then case cursor_left block_number typesetting seq_seq_char cursor of
                                            Nothing->return (Nothing,Nothing)
                                            Just (new_cursor_row,Nothing)->if row<=new_cursor_row&&new_cursor_row<row+row_number then return (Nothing,Nothing) else return (Nothing,Just (Leaf_widget next_id (Editor window_id block_number row_number new_cursor_row design_font_size font_size True path find typesetting text_red text_green text_blue text_alpha cursor_red cursor_green cursor_blue cursor_alpha select_red select_green select_blue select_alpha height design_block_width design_delta_height design_x design_y design_extra_width design_extra_height font_height block_width delta_height x y left right up down cursor seq_seq_char)))
                                            Just (new_cursor_row,Just new_cursor)->return (Nothing,Just (Leaf_widget next_id (Editor window_id block_number row_number (if row<=new_cursor_row&&new_cursor_row<row+row_number then row else min (DS.length seq_seq_char-row_number) new_cursor_row) design_font_size font_size True path find typesetting text_red text_green text_blue text_alpha cursor_red cursor_green cursor_blue cursor_alpha select_red select_green select_blue select_alpha height design_block_width design_delta_height design_x design_y design_extra_width design_extra_height font_height block_width delta_height x y left right up down new_cursor seq_seq_char)))
                                            ...
                                            then case cursor_right (DS.length seq_seq_char-1) block_number typesetting seq_seq_char cursor of
                                                Nothing->return (Nothing,Nothing)
                                                Just (new_cursor_row,Nothing)->if row<=new_cursor_row&&new_cursor_row<row+row_number then return (Nothing,Nothing) else return (Nothing,Just (Leaf_widget next_id (Editor window_id block_number row_number (max 0 (new_cursor_row+1-row_number)) design_font_size font_size True path find typesetting text_red text_green text_blue text_alpha cursor_red cursor_green cursor_blue cursor_alpha select_red select_green select_blue select_alpha height design_block_width design_delta_height design_x design_y design_extra_width design_extra_height font_height block_width delta_height x y left right up down cursor seq_seq_char)))
                                                        ...
                                                        then case cursor_min block_number typesetting seq_seq_char cursor of
                                                            ...
                                                            then let max_row=DS.length seq_seq_char-1 in case cursor_max max_row block_number typesetting seq_seq_char cursor of
                                                                ...
                                                                then case cursor_paragraph_min block_number typesetting seq_seq_char cursor of
                                                                    Nothing->return (Nothing,Nothing)
                                                                    Just (new_cursor_row,Nothing)->if row<=new_cursor_row&&new_cursor_row<row+row_number then return (Nothing,Nothing) else return (Nothing,Just (Leaf_widget next_id (Editor window_id block_number row_number (min (DS.length seq_seq_char-row_number) new_cursor_row) design_font_size font_size True path find typesetting text_red text_green text_blue text_alpha cursor_red cursor_green cursor_blue cursor_alpha select_red select_green select_blue select_alpha height design_block_width design_delta_height design_x design_y design_extra_width design_extra_height font_height block_width delta_height x y left right up down cursor seq_seq_char)))
                                                                    Just (new_cursor_row,Just new_cursor)->return (Nothing,Just (Leaf_widget next_id (Editor window_id block_number row_number (if row<=new_cursor_row&&new_cursor_row<row+row_number then row else min (DS.length seq_seq_char-row_number) new_cursor_row) design_font_size font_size True path find typesetting text_red text_green text_blue text_alpha cursor_red cursor_green cursor_blue cursor_alpha select_red select_green select_blue select_alpha height design_block_width design_delta_height design_x design_y design_extra_width design_extra_height font_height block_width delta_height x y left right up down new_cursor seq_seq_char)))
