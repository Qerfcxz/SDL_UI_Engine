...
to_single_widget_record (Canvas canvas)=Canvas_record canvas
...
to_single_widget_record (Coroutine coroutine)=Coroutine_record coroutine
...
to_single_widget_record (Geometry window_id red green blue alpha geometry)=Geometry_record window_id red green blue alpha geometry
to_single_widget_record (Picture window_id texture similarity original_width original_height x y width height)=Picture_record window_id texture similarity original_width original_height x y width height
to_single_widget_record (Animation window_id count index seq_frame similarity)=Animation_record window_id count index seq_frame similarity
...
from_single_widget_record (Canvas_record canvas)=Canvas canvas
...
from_single_widget_record (Coroutine_record coroutine)=Coroutine coroutine
...
from_single_widget_record (Geometry_record window_id red green blue alpha geometry)=Geometry window_id red green blue alpha geometry
from_single_widget_record (Picture_record window_id texture similarity original_width original_height x y width height)=Picture window_id texture similarity original_width original_height x y width height
from_single_widget_record (Animation_record window_id count index seq_frame similarity)=Animation window_id count index seq_frame similarity
...
to_raw_request_record (Switch_render_target window_id index seq_id)=Switch_render_target_record window_id index seq_id
to_raw_request_record (Reset_render_target window_id)=Reset_render_target_record window_id
to_raw_request_record (Create_canvas transmit window_id index seq_id)=Create_canvas_record transmit window_id index seq_id
to_raw_request_record (Remove_canvas transmit index seq_id)=Remove_canvas_record transmit index seq_id
to_raw_request_record (Io io)=Io_record io
to_raw_request_record (Render_geometry window_id red green blue alpha geometry_request)=Render_geometry_record window_id red green blue alpha geometry_request
...
to_raw_request_record (Render_geometry_widget transmit seq_id)=Render_geometry_widget_record transmit seq_id
to_raw_request_record (Render_picture_widget transmit seq_id)=Render_picture_widget_record transmit seq_id
to_raw_request_record (Render_animation_widget transmit seq_id)=Render_animation_widget_record transmit seq_id
...
to_raw_request_record (Render_canvas_widget transmit similarity left right up down index seq_id)=Render_canvas_widget_record transmit similarity left right up down index seq_id
...
from_raw_request_record (Switch_render_target_record window_id index seq_id)=Switch_render_target window_id index seq_id
from_raw_request_record (Reset_render_target_record window_id)=Reset_render_target window_id
from_raw_request_record (Create_canvas_record transmit window_id index seq_id)=Create_canvas transmit window_id index seq_id
from_raw_request_record (Remove_canvas_record transmit index seq_id)=Remove_canvas transmit index seq_id
from_raw_request_record (Io_record io)=Io io
from_raw_request_record (Render_geometry_record window_id red green blue alpha geometry_request)=Render_geometry window_id red green blue alpha geometry_request
...
from_raw_request_record (Render_geometry_widget_record transmit seq_id)=Render_geometry_widget transmit seq_id
from_raw_request_record (Render_picture_widget_record transmit seq_id)=Render_picture_widget transmit seq_id
from_raw_request_record (Render_animation_widget_record transmit seq_id)=Render_animation_widget transmit seq_id
...
from_raw_request_record (Render_canvas_widget_record transmit similarity left right up down index seq_id)=Render_canvas_widget transmit similarity left right up down index seq_id
...
data Single_widget_request_record a=Label_data_request_record {label::Label}|Bool_data_request_record {bool::Bool}|Int_data_request_record {int::Int}|Char_data_request_record {char::Char}|List_char_data_request_record {list_char::List_char}|Data_request_record {content::a}|Canvas_request_record|Trigger_request_record {trigger::Event->Engine a->Engine a}|Io_trigger_request_record {io_trigger::Event->Engine a->IO (Engine a)}|Coroutine_request_record {coroutine::Coroutine a}|Collector_request_record {request::DIS.IntMap (Request a)}|Font_request_record {path::DT.Text,size::DSeq.Seq Int}|Block_font_request_record {window_id::Int,red::DW.Word8,green::DW.Word8,blue::DW.Word8,alpha::DW.Word8,path::DT.Text,size::DSeq.Seq Int}|Geometry_request_record {window_id::Int,red::DW.Word8,green::DW.Word8,blue::DW.Word8,alpha::DW.Word8,geometry_request::Geometry_request}|Picture_request_record {window_id::Int,path::DT.Text,similarity::Similarity}|Animation_request_record {window_id::Int,seq_path::DSeq.Seq DT.Text,similarity::Similarity}|Text_request_record {window_id::Int,find::Find,delta_height::FCT.CInt,left::FCT.CInt,right::FCT.CInt,up::FCT.CInt,down::FCT.CInt,seq_paragraph::DSeq.Seq Paragraph,text_binding::Text_binding}|Editor_request_record {window_id::Int,block_number::Int,font_size::Int,font_path::DSeq.Seq Int,block_find::Block_find,typesetting::Typesetting,text_red::DW.Word8,text_green::DW.Word8,text_blue::DW.Word8,text_alpha::DW.Word8,cursor_red::DW.Word8,cursor_green::DW.Word8,cursor_blue::DW.Word8,cursor_alpha::DW.Word8,select_red::DW.Word8,select_green::DW.Word8,select_blue::DW.Word8,select_alpha::DW.Word8,block_width::FCT.CInt,height::FCT.CInt,delta_height::FCT.CInt,x::FCT.CInt,y::FCT.CInt,extra_width::FCT.CInt,extra_height::FCT.CInt,ime_left::FCT.CInt,ime_right::FCT.CInt,ime_up::FCT.CInt,ime_down::FCT.CInt,seq_seq_char::DSeq.Seq (DSeq.Seq Char),editor_binding::Editor_binding}
...
to_single_widget_request_record Canvas_request=Canvas_request_record
...
to_single_widget_request_record (Coroutine_request coroutine)=Coroutine_request_record coroutine
...
to_single_widget_request_record (Geometry_request window_id red green blue alpha geometry_request)=Geometry_request_record window_id red green blue alpha geometry_request
to_single_widget_request_record (Picture_request window_id path similarity)=Picture_request_record window_id path similarity
to_single_widget_request_record (Animation_request window_id seq_path similarity)=Animation_request_record window_id seq_path similarity
...
from_single_widget_request_record Canvas_request_record=Canvas_request
...
from_single_widget_request_record (Coroutine_request_record coroutine)=Coroutine_request coroutine
...
from_single_widget_request_record (Geometry_request_record window_id red green blue alpha geometry_request)=Geometry_request window_id red green blue alpha geometry_request
from_single_widget_request_record (Picture_request_record window_id path similarity)=Picture_request window_id path similarity
from_single_widget_request_record (Animation_request_record window_id seq_path similarity)=Animation_request window_id seq_path similarity
