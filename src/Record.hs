...
to_single_widget_record (Canvas window_id allow intmap_texture)=Canvas_record window_id allow intmap_texture
...
from_single_widget_record (Canvas_record window_id allow intmap_texture)=Canvas window_id allow intmap_texture
...
to_single_widget_request_record (Canvas_request window_id allow)=Canvas_request_record window_id allow
...
from_single_widget_request_record (Canvas_request_record window_id allow)=Canvas_request window_id allow
