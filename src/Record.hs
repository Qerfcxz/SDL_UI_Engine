...
to_single_widget_record (Animation window_id count index seq_frame render_flip angle design_x design_y width_multiply width_divide height_multiply height_divide)=Animation_record window_id count index seq_frame render_flip angle design_x design_y width_multiply width_divide height_multiply height_divide
...
from_single_widget_record (Animation_record window_id count index seq_frame render_flip angle design_x design_y width_multiply width_divide height_multiply height_divide)=Animation window_id count index seq_frame render_flip angle design_x design_y width_multiply width_divide height_multiply height_divide
...
to_raw_request_record (Render_canvas_widget transmit left right up down index seq_id)=Render_canvas_widget_record transmit left right up down index seq_id
...
from_raw_request_record (Render_canvas_widget_record transmit left right up down index seq_id)=Render_canvas_widget transmit left right up down index seq_id
...
data Single_widget_request_record a=Label_data_request_record {label::Label}|Bool_data_request_record {bool::Bool}|Int_data_request_record {int::Int}|Char_data_request_record {char::Char}|List_char_data_request_record {list_char::List_char}|Data_request_record {content::a}|Canvas_request_record|Trigger_request_record {trigger::Event->Engine a->Engine a}|Io_trigger_request_record {io_trigger::Event->Engine a->IO (Engine a)}|Collector_request_record {request::DIS.IntMap (Request a)}|Font_request_record {path::DT.Text,size::DSeq.Seq Int}|Block_font_request_record {window_id::Int,red::DW.Word8,green::DW.Word8,blue::DW.Word8,alpha::DW.Word8,path::DT.Text,size::DSeq.Seq Int}|Rectangle_request_record {window_id::Int,red::DW.Word8,green::DW.Word8,blue::DW.Word8,alpha::DW.Word8,left::FCT.CInt,right::FCT.CInt,up::FCT.CInt,down::FCT.CInt}|Picture_request_record {window_id::Int,path::DT.Text,render_flip::Flip,angle::FCT.CDouble,x::FCT.CInt,y::FCT.CInt,width_multiply::FCT.CInt,width_divide::FCT.CInt,height_multiply::FCT.CInt,height_divide::FCT.CInt}|Animation_request_record {window_id::Int,seq_path::DSeq.Seq DT.Text,render_flip::Flip,angle::FCT.CDouble,x::FCT.CInt,y::FCT.CInt,width_multiply::FCT.CInt,width_divide::FCT.CInt,height_multiply::FCT.CInt,height_divide::FCT.CInt}|Text_request_record {window_id::Int,find::Find,delta_height::FCT.CInt,left::FCT.CInt,right::FCT.CInt,up::FCT.CInt,down::FCT.CInt,seq_paragraph::DSeq.Seq Paragraph,text_binding::Text_binding}|Editor_request_record {window_id::Int,block_number::Int,font_size::Int,font_path::DSeq.Seq Int,block_find::Block_find,typesetting::Typesetting,text_red::DW.Word8,text_green::DW.Word8,text_blue::DW.Word8,text_alpha::DW.Word8,cursor_red::DW.Word8,cursor_green::DW.Word8,cursor_blue::DW.Word8,cursor_alpha::DW.Word8,select_red::DW.Word8,select_green::DW.Word8,select_blue::DW.Word8,select_alpha::DW.Word8,block_width::FCT.CInt,height::FCT.CInt,delta_height::FCT.CInt,x::FCT.CInt,y::FCT.CInt,extra_width::FCT.CInt,extra_height::FCT.CInt,ime_left::FCT.CInt,ime_right::FCT.CInt,ime_up::FCT.CInt,ime_down::FCT.CInt,seq_seq_char::DSeq.Seq (DSeq.Seq Char),editor_binding::Editor_binding}
...
to_single_widget_request_record (Animation_request window_id seq_path render_flip angle x y width_multiply width_divide height_multiply height_divide)=Animation_request_record window_id seq_path render_flip angle x y width_multiply width_divide height_multiply height_divide
...
from_single_widget_request_record (Animation_request_record window_id seq_path render_flip angle x y width_multiply width_divide height_multiply height_divide)=Animation_request window_id seq_path render_flip angle x y width_multiply width_divide height_multiply height_divide
