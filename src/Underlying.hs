...
angle_picture_combined_widget angle (Leaf_widget next_id (Picture window_id texture render_flip _ design_x design_y width_multiply width_divide height_multiply height_divide original_width original_height x y width height))=Leaf_widget next_id (Picture window_id texture render_flip angle design_x design_y width_multiply width_divide height_multiply height_divide original_width original_height x y width height)
