...
move_rectangle _ _ _ combined_widget=combined_widget
...
move_picture _ _ _ combined_widget=combined_widget
...
move_text _ _ _ combined_widget=combined_widget
...
move_editor _ _ _ combined_widget=combined_widget

set_render_false::Combined_widget a->Combined_widget a
set_render_false (Leaf_widget next_id (Text window_id row max_row _ select find design_delta_height design_left design_right design_up design_down delta_height left right up down seq_paragraph seq_row))=Leaf_widget next_id (Text window_id row max_row False select find design_delta_height design_left design_right design_up design_down delta_height left right up down seq_paragraph seq_row)
...
set_render_false _=error "set_render_false: error 1"