...
remove_widget_only::Data a=>Int->Int->Engine a->IO (Engine a)
remove_widget_only combined_id single_id (Engine widget window window_map request key main_id start_id count_id time)=do
...
remove_widget::Data a=>Int->Int->Engine a->IO (Engine a)
remove_widget combined_id single_id (Engine widget window window_map request key main_id start_id count_id time)=do
    (intmap_combined_widget,new_widget)<-remove_widget_a combined_id single_id widget
...
remove_widget_a::Data a=>Int->Int->DIS.IntMap (DIS.IntMap (Combined_widget a))->IO (DIS.IntMap (Combined_widget a),DIS.IntMap (DIS.IntMap (Combined_widget a)))
remove_widget_a combined_id single_id widget=let (combined_widget,intmap_combined_widget,new_widget)=error_remove_remove "remove_widget_a: error 1" "remove_widget_a: error 2" combined_id single_id widget in case combined_widget of
