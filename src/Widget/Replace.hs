...
replace_widget::Data a=>(Combined_widget a->IO (Combined_widget a))->Int->Int->Combined_widget_request a->Engine a->IO (Engine a)
replace_widget transform combined_id single_id combined_widget_request (Engine widget window window_map request key main_id start_id count_id time)=do
