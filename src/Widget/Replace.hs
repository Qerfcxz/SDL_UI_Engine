...
replace_widget_a seq_id count_id combined_id single_id start_id window combined_widget_request widget=case seq_id of
    ...
    (new_single_id DS.:<| other_seq_single_id)->case error_lookup_lookup "replace_widget_a: error 1" "replace_widget_a: error 2" combined_id single_id widget of
        Leaf_widget _ _->error "replace_widget_a: error 3"
        Node_widget _ _ _ _ new_combined_id->replace_widget_a other_seq_single_id count_id new_combined_id new_single_id start_id window combined_widget_request widget