...
remove_widget_instruction::Instruction->Engine a->Combined_widget a->IO (Combined_widget a)
remove_widget_instruction _ _=return

alter_widget_instruction::Instruction->Engine a->Combined_widget a->IO (Combined_widget a)
alter_widget_instruction _ _=return

replace_widget_instruction::Instruction->Engine a->Combined_widget a->IO (Combined_widget a)
...
move_render_rectangle (Move_render_rectangle delta_x delta_y) engine=return.move_rectangle delta_x delta_y engine
move_render_rectangle _ _=return

move_render_picture::Instruction->Engine a->(Combined_widget a->IO (Combined_widget a))
move_render_picture (Move_render_picture delta_x delta_y) engine=return.move_picture delta_x delta_y engine
move_render_picture _ _=return

move_render_text::Instruction->Engine a->(Combined_widget a->IO (Combined_widget a))
move_render_text (Move_render_text delta_x delta_y) engine=return.move_text delta_x delta_y engine
move_render_text _ _=return

move_render_editor::Instruction->Engine a->(Combined_widget a->IO (Combined_widget a))
move_render_editor (Move_render_editor delta_x delta_y) engine=return.move_editor delta_x delta_y engine
move_render_editor _ _=return

update_block_font_instruction::Instruction->Engine a->(FCT.CInt,DSet.Set Char,DSeq.Seq Int,Combined_widget a)->IO (FCT.CInt,DSet.Set Char,DSeq.Seq Int,Combined_widget a)
