...
error_remove_simple::GS.HasCallStack=>[Char]->Int->DIS.IntMap a->DIS.IntMap a
...
error_remove::GS.HasCallStack=>[Char]->Int->DIS.IntMap a->(a,DIS.IntMap a)
...
error_remove_remove::GS.HasCallStack=>[Char]->[Char]->Int->Int->DIS.IntMap (DIS.IntMap a)->(a,DIS.IntMap a,DIS.IntMap (DIS.IntMap a))
...
error_insert::GS.HasCallStack=>[Char]->Int->a->DIS.IntMap a->DIS.IntMap a
...
error_insert_insert_a::GS.HasCallStack=>[Char]->[Char]->Int->a->Maybe (DIS.IntMap a)->Maybe (DIS.IntMap a)
...
error_replace_replace_a::GS.HasCallStack=>[Char]->[Char]->Int->a->Maybe (DIS.IntMap a)->Maybe (DIS.IntMap a)
...
error_update_a::GS.HasCallStack=>[Char]->(a->a)->Maybe a->Maybe a
...
error_get_update_update_b::GS.HasCallStack=>[Char]->(a->a)->Maybe a->(a,Maybe a)
...
error_update_update_b::GS.HasCallStack=>[Char]->(a->a)->Maybe a->Maybe a
