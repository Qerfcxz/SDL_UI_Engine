...
set_engine_main_id::(Event->Engine a->Int)->Engine a->Engine a
...
set_main_id::(Event->Engine a->Int)->DSeq.Seq Int->Engine a->Engine a
...
set_main_id_a::(Event->Engine a->Int)->Combined_widget a->Combined_widget a
