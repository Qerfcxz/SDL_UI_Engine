...
get_render::GS.HasCallStack=>DS.Seq Int->Engine a->Bool
get_render seq_id engine=case get_widget seq_id engine of
    Leaf_widget _ (Text _ _ _ render _ _ _ _ _ _ _ _ _ _ _ _ _ _ _)->render
    Leaf_widget _ (Editor _ _ _ _ _ _ render _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _)->render
...
get_adaptive window_id (Engine _ window _ _ _ _ _ _ _)=case error_lookup "get_adaptive: error 1" window_id window of
...
get_widget::GS.HasCallStack=>DS.Seq Int->Engine a->Combined_widget a
...
get_widget_widget::GS.HasCallStack=>DS.Seq Int->Int->DIS.IntMap (DIS.IntMap (Combined_widget a))->Combined_widget a
get_widget_widget seq_id start_id widget=case seq_id of
    DS.Empty->error "get_widget_widget: error 1"
    single_id DS.:<| other_seq_single_id->get_widget_widget_a start_id single_id other_seq_single_id widget

get_widget_widget_a::GS.HasCallStack=>Int->Int->DS.Seq Int->DIS.IntMap (DIS.IntMap (Combined_widget a))->Combined_widget a
...
get_widget_id_with_transform::GS.HasCallStack=>DS.Seq Int->Engine a->(Int,Int,DS.Seq (Engine a->Raw_request a->DS.Seq Instruction->Maybe (DS.Seq Instruction)))
...
get_widget_id_with_transform_a::GS.HasCallStack=>Int->Int->DS.Seq Int->DIS.IntMap (DIS.IntMap (Combined_widget a))->DS.Seq (Engine a->Raw_request a->DS.Seq Instruction->Maybe (DS.Seq Instruction))->(Int,Int,DS.Seq (Engine a->Raw_request a->DS.Seq Instruction->Maybe (DS.Seq Instruction)))
...
get_widget_id_widget::GS.HasCallStack=>DS.Seq Int->Int->DIS.IntMap (DIS.IntMap (Combined_widget a))->(Int,Int)
...
get_widget_id_widget_a::GS.HasCallStack=>DS.Seq Int->Int->Int->DIS.IntMap (DIS.IntMap (Combined_widget a))->(Int,Int)
